...
<body>
    ...
    <div class="uk-container">
        ...
        <h2 class="uk-text-center">New animated series: Max & Maestro</h2>
				<div id="contena">
	            ...
	            <div class="uk-width-1-1@m">
								<article class="uk-article">
									...
									<img class="uk-align-left uk-text-justify uk-margin-remove-adjacent" data-src="./assets/images/header.jpg" width="400" height="400" alt="" uk-img>
									<p>Woodwork, painting, electrical, plumbing, and more. My services
											...
											come with the same promise of quality, dedication, and durability. Licensed and insured, I’m an experienced contractor with knowledge.
											Woodwork, painting, electrical, plumbing, and more. My services might be varied, but they all come with the same promise of quality, dedication, and durability.
											Licensed and insured, I’m an experienced contractor with knowledge.</p>
	...
	<div class="uk-section">
		<div class="uk-container">
			<ul class="uk-pagination">
			    <li><a  class="sct-main-color" href="#"><span class="uk-margin-small-right" uk-pagination-previous></span> Previous</a>Melissa appears in trio recital throughout April</li>
			    <li class="uk-margin-auto-left uk-text-right"><a class="sct-main-color" href="#">Next <span class="uk-margin-small-left" uk-pagination-next></span></a>May with the Staatskapelle Berlin</li>
			</ul>
		</div>
	</div>
