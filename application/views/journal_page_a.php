...
<body>
    ...
    <div class="uk-container">
        <h2 class="uk-text-center sct-main-color">JOURNAL: Archive</h2>
					<ul class="uk-subnav sct-nav" uk-margin>
						<li><a href='#'>2015</a></li>
						<li><a href='#'>2016</a></li>
						<li><a href="#">2017</a></li>
						<li><a href="#">2018</a></li>
				...
				<div id="contena">
					<h2 class="sct-main-color">January</h2>
					<div class="uk-child-width-1-3@m" uk-grid>
				        ...
				        <div class="uk-card uk-card-default">
				            ...
				            <div class="uk-card-body">
				                <h3 class="uk-card-title">Donate equipment</h3>
				                <p>Woodwork, painting, electrical, plumbing, and more.
														My services might be varied, but they all come with
														the same promise
														of quality, dedication, and durability. Licensed and
														insured, I’m an experienced</p>
				        ...
				        <div class="uk-card uk-card-default">
				            ...
				            <div class="uk-card-body">
				                <h3 class="uk-card-title">Donate foods</h3>
				                <p>Woodwork, painting, electrical, plumbing, and more.
														My services might be varied, but they all come with
														the same promise
														of quality, dedication, and durability. Licensed and
				        ...
				        <div class="uk-card uk-card-default">
				            <div class="uk-card-media-top">
				                <img class="ini-img-custom" height="200" src="./assets/images/3.png" alt="">
				            </div>
				            <div class="uk-card-body">
				                <h3 class="uk-card-title">Donate medical</h3>
				                <p>Woodwork, painting, electrical, plumbing, and more.
														My services might be varied, but they all come with
														the same promise
														of quality, dedication, and durability. Licensed and
				        ...
				        <div class="uk-card uk-card-default">
				            <div class="uk-card-media-top">
				                <img class="ini-img-custom" src="./assets/images/feater.png" alt="">
				            </div>
				            <div class="uk-card-body">
				                <h3 class="uk-card-title">Donate equipment</h3>
				                <p>Woodwork, painting, electrical, plumbing, and more.
				        ...
				        <div class="uk-card uk-card-default">
				            <div class="uk-card-media-top">
				                <img class="ini-img-custom" src="./assets/images/4.png" alt="">
				            </div>
				            <div class="uk-card-body">
				                <h3 class="uk-card-title">Donate foods</h3>
				                <p>Woodwork, painting, electrical, plumbing, and more.
				        ...
				        <div class="uk-card uk-card-default">
				            <div class="uk-card-media-top">
				                <img class="ini-img-custom" height="200" src="./assets/images/5.jpg" alt="">
				            </div>
				            <div class="uk-card-body">
				                <h3 class="uk-card-title">Donate medical</h3>
				                <p>Woodwork, painting, electrical, plumbing, and more.
				        ...
				        <div class="uk-card uk-card-default">
				            <div class="uk-card-media-top">
				                <img class="ini-img-custom" src="./assets/images/6.jpg" alt="">
				            </div>
				            <div class="uk-card-body">
				                <h3 class="uk-card-title">Donate equipment</h3>
				                <p>Woodwork, painting, electrical, plumbing, and more.
				        ...
				        <div class="uk-card uk-card-default">
				            <div class="uk-card-media-top">
				                <img class="ini-img-custom" src="./assets/images/header.jpg" alt="">
				            </div>
				            <div class="uk-card-body">
				                <h3 class="uk-card-title">Donate foods</h3>
				                <p>Woodwork, painting, electrical, plumbing, and more.
				        ...
				        <div class="uk-card uk-card-default">
				            <div class="uk-card-media-top">
				                <img class="ini-img-custom" height="200" src="./assets/images/7.jpg" alt="">
				            </div>
				            <div class="uk-card-body">
				                <h3 class="uk-card-title">Donate medical</h3>
				                <p>Woodwork, painting, electrical, plumbing, and more.
					...
					<hr />
					<h2 class="sct-main-color">February</h2>
					<div class="uk-child-width-1-3@m" uk-grid>
						<div>
				        <div class="uk-card uk-card-default">
				            <div class="uk-card-media-top">
				                <img class="ini-img-custom" src="./assets/images/8.jpg" alt="">
				            </div>
				            <div class="uk-card-body">
				                <h3 class="uk-card-title">Donate equipment</h3>
				                <p>Woodwork, painting, electrical, plumbing, and more.
				        ...
				        <div class="uk-card uk-card-default">
				            <div class="uk-card-media-top">
				                <img class="ini-img-custom" src="./assets/images/9.jpg" alt="">
				            </div>
				            <div class="uk-card-body">
				                <h3 class="uk-card-title">Donate foods</h3>
				                <p>Woodwork, painting, electrical, plumbing, and more.
				        ...
				        <div class="uk-card uk-card-default">
				            <div class="uk-card-media-top">
				                <img class="ini-img-custom" height="200" src="./assets/images/10.jpg" alt="">
				            </div>
				            <div class="uk-card-body">
				                <h3 class="uk-card-title">Donate medical</h3>
				                <p>Woodwork, painting, electrical, plumbing, and more.
