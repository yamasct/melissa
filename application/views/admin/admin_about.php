        		...
        		<form class="uk-form-horizontal">
					    <div class="uk-margin">
					        ...
					        <div class="uk-form-controls">
					            ...
					            <input class="uk-input uk-form-width-large" id="form-stacked-text" type="date" name="date">
					        </div>
					    </div>
					    <div class="uk-margin">
