...
<body>
    ...
    <div class="uk-container">
        <h2 class="uk-text-center sct-main-color">CATALOGUE</h2>
				...
				<div id="contena">
					<div class="uk-child-width-1-3@m" uk-grid>
				        ...
				        <div class="uk-card uk-card-default">
				            <div class="uk-card-media-top">
				                <img class="ini-img-custom" src="./assets/images/13.jpg" alt="">
				            </div>
				            <div class="uk-card-body">
				                <h3 class="uk-card-title">Donate foods</h3>
				                <p>Woodwork, painting, electrical, plumbing, and more.
				        ...
				        <div class="uk-card uk-card-default">
				            <div class="uk-card-media-top">
				                <img class="ini-img-custom" height="200" src="./assets/images/4.png" alt="">
				            </div>
				            <div class="uk-card-body">
				                <h3 class="uk-card-title">Donate medical</h3>
				                <p>Woodwork, painting, electrical, plumbing, and more.
